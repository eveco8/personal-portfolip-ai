...
const PROJECTS = [
  {
    ...
    description: 'An interactive web app for collecting and exploring digital cat cards — complete with images, GIFs, and cat facts. Built as a collaborative project, it demonstrates dynamic DOM manipulation, API integration, and a polished responsive UI.',
    github: 'https://github.com/Joshua-Evelin-mls/mod-4-project',
    live: 'https://joshua-evelin-mls.github.io/mod-4-project/',
    clueId: 'CLUE_003',
    clueText: 'Project evidence recovered: subject is drawn to building things that are joyful and interactive — not just functional. The cat cards were a deliberate design choice.',
    finding: 'Subject builds with personality. The code is clean, but the intent is clear — she wants users to smile.',
  },
  {
    id: 'proj-002',
    caseNum: 'EXHIBIT B-2',
    ...
    description: 'A terminal-based Rock Paper Scissors game where you play against the computer. Demonstrates core JavaScript logic, control flow, and Node.js fundamentals — the kind of project that proves you understand the language before you reach for a framework.',
    github: 'https://github.com/eveco8/rock-paper-scissors',
    live: null,
    clueId: 'CLUE_004',
    clueText: 'Second project file recovered. Subject started from first principles — no frameworks, no shortcuts. She learned the foundations before reaching for the tools.',
    finding: 'Motive confirmed: she builds to understand, not just to ship.',
  },
  {
    id: 'proj-003',
    caseNum: 'EXHIBIT B-3',
    ...
    description: 'The portfolio site that started it all — a hand-coded showcase of her projects, skills, and journey as a software engineering fellow. Built without frameworks to prove command of the fundamentals. You may have seen it before investigating this case.',
    github: 'https://github.com/eveco8/eveco8.github.io',
    live: 'https://eveco8.github.io/',
    clueId: null,
    clueText: null,
    finding: 'This is the breadcrumb that led you here, Detective.',
  },
];
